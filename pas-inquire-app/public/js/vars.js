...
export const SCHEMA = [
  ...
  { group: "Inquiry Search Keys", fields: [
    { key: "caseIdSystem", label: "Case ID system (IOCaseNumber)", default: "https://code.evicore.com/IOCaseNumber" },
    { key: "caseIdValue", label: "Case ID (IOCaseNumber)", default: "1245887913" },
    { key: "servicingProviderNpi", label: "Servicing/rendering provider NPI", default: "1234567890" },
    { key: "certIssueDate", label: "Cert issue date", default: "2025-01-15" },
    { key: "certEffectiveDate", label: "Cert effective date", default: "2025-01-20" },
    { key: "certExpirationDateStart", label: "Cert expiration range start", default: "2025-06-01" },
    { key: "certExpirationDateEnd", label: "Cert expiration range end", default: "2025-06-30" },
    { key: "serviceDateStart", label: "Service date range start", default: "2025-01-01" },
    { key: "serviceDateEnd", label: "Service date range end", default: "2025-01-31" },
    { key: "badMemberIdValue", label: "Unknown member ID (negative test)", default: "ZZZ-00000000000" },
    { key: "badAuthRefNumber", label: "Invalid Auth ID (negative test)", default: "A000000000-BAD" },
  ]},
